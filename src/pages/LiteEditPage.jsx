  ...
  return (
    <div className="min-h-screen bg-art-black text-white pt-24 md:pt-32 px-4 md:px-10 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center max-w-7xl mx-auto mb-8 md:mb-10 gap-4">
        <h1 className="text-3xl md:text-4xl font-serif">Go Lite Studio</h1>
      ...
      <div className="max-w-7xl mx-auto min-h-[600px] bg-white/5 rounded-3xl border border-white/10 relative overflow-hidden flex flex-col items-center justify-center p-10">
        ...
        {step === 1 && (
            <div className="text-center flex flex-col items-center gap-8 fade-up">
                ...
                <div>
                    <h2 className="text-3xl font-serif mb-4">Upload Photo for Lite Edit</h2>
                    <p className="text-gray-400 max-w-md mx-auto">
                        Quick edits using our lightweight AI model. Fast and efficient.
                    </p>
                </div>
        ...
        {step === 2 && (
            <div className="text-center space-y-6 fade-up">
                ...
                <p className="text-gray-400">Identifying structure for Lite Edit</p>
            </div>
        )}
        ...
        {step === 4 && (
            <div className="text-center space-y-8 fade-up">
                ...
                <div>
                    <h2 className="text-3xl font-serif mb-2">Generating Lite Edit...</h2>
                    <p className="text-gray-400">Applying style with Gemini Flash Image</p>
                </div>
            </div>
        )}
        ...
        {step === 5 && (
            <div className="w-full h-full flex flex-col items-center fade-up">
                <div className="relative w-full max-w-2xl aspect-square rounded-xl overflow-hidden mb-8 border border-white/20 shadow-2xl shadow-art-accent/20">
                    <img src={resultImage} alt="Generated Art" className="w-full h-full object-contain bg-black/50" />
                </div>
